...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1455318415;
...
fn wire__crate__bridge__relay_ping_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::bridge::relay_ping().await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        14 => wire__crate__bridge__relay_ping_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__bridge__restart_server_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__bridge__send_files_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__bridge__setup_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__bridge__shutdown_server_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__bridge__start_server_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
