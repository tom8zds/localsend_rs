...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1455318415;
...
abstract class RustLibApi extends BaseApi {
  Future<void> crateBridgeAcceptSession(
      {required String sessionId, List<String>? fileIds});

  Future<void> crateBridgeAnnounce();

  Future<void> crateBridgeCancelSession({required String sessionId});
  ...
  Future<void> crateBridgeDeclineSession({required String sessionId});

  Stream<List<NodeDevice>> crateBridgeListenDevice();

  Stream<String?> crateBridgeListenServerError();

  Stream<bool> crateBridgeListenServerState();

  Stream<SessionEvent> crateBridgeListenSession({required String sessionId});

  Stream<List<SessionSummary>> crateBridgeListenSessionIndex();

  Future<NodeDevice?> crateBridgeManualDevice({required String addr});

  Future<BigInt> crateBridgeRelayPing();

  Future<void> crateBridgeRestartServer();

  Future<String> crateBridgeSendFiles(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateBridgeAcceptSession(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_opt_list_String(fileIds, serializer);
      ...
      constMeta: kCrateBridgeAcceptSessionConstMeta,
      argValues: [sessionId, fileIds],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBridgeAcceptSessionConstMeta => const TaskConstMeta(
        debugName: "accept_session",
        argNames: ["sessionId", "fileIds"],
      );
  ...
  Future<void> crateBridgeCancelSession({required String sessionId}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateBridgeCancelSessionConstMeta,
      argValues: [sessionId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBridgeCancelSessionConstMeta => const TaskConstMeta(
  ...
  Future<void> crateBridgeDeclineSession({required String sessionId}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateBridgeDeclineSessionConstMeta,
      argValues: [sessionId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBridgeDeclineSessionConstMeta => const TaskConstMeta(
        debugName: "decline_session",
        argNames: ["sessionId"],
      );
  ...
  Stream<String?> crateBridgeListenServerError() {
    ...
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_StreamSink_opt_String_Sse(s, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 9, port: port_);
      },
      codec: SseCodec(
      ...
      constMeta: kCrateBridgeListenServerErrorConstMeta,
      argValues: [s],
      apiImpl: this,
    )));
    return s.stream;
  ...
  TaskConstMeta get kCrateBridgeListenServerErrorConstMeta =>
      const TaskConstMeta(
        debugName: "listen_server_error",
        argNames: ["s"],
      );
  ...
  @override
  Stream<SessionEvent> crateBridgeListenSession({required String sessionId}) {
    final s = RustStreamSink<SessionEvent>();
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(sessionId, serializer);
        sse_encode_StreamSink_session_event_Sse(s, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
  ...
  TaskConstMeta get kCrateBridgeListenSessionConstMeta => const TaskConstMeta(
        ...
        argNames: ["sessionId", "s"],
      );

  @override
  Stream<List<SessionSummary>> crateBridgeListenSessionIndex() {
    final s = RustStreamSink<List<SessionSummary>>();
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_StreamSink_list_session_summary_Sse(s, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateBridgeListenSessionIndexConstMeta,
      argValues: [s],
      apiImpl: this,
    )));
    return s.stream;
  ...
  TaskConstMeta get kCrateBridgeListenSessionIndexConstMeta =>
      const TaskConstMeta(
        debugName: "listen_session_index",
        argNames: ["s"],
      );
  ...
  Future<NodeDevice?> crateBridgeManualDevice({required String addr}) {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_opt_box_autoadd_node_device,
        decodeErrorData: null,
      ),
      constMeta: kCrateBridgeManualDeviceConstMeta,
      argValues: [addr],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBridgeManualDeviceConstMeta => const TaskConstMeta(
        debugName: "manual_device",
        argNames: ["addr"],
      );
  ...
  Future<BigInt> crateBridgeRelayPing() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateBridgeRelayPingConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBridgeRelayPingConstMeta => const TaskConstMeta(
        debugName: "relay_ping",
        argNames: [],
      );
  ...
  Future<String> crateBridgeSendFiles(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_node_device(target, serializer);
      ...
      constMeta: kCrateBridgeSendFilesConstMeta,
      argValues: [target, files],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBridgeSendFilesConstMeta => const TaskConstMeta(
        debugName: "send_files",
        argNames: ["target", "files"],
      );
  ...
  FileState dco_decode_box_autoadd_file_state(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_file_state(raw);
  }
  ...
  NodeDevice? dco_decode_opt_box_autoadd_node_device(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_node_device(raw);
  }
  ...
  SessionEvent dco_decode_session_event(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return SessionEvent_StateChanged(
          dco_decode_mission_state(raw[1]),
        );
      case 1:
        return SessionEvent_FileStateChanged(
          fileId: dco_decode_String(raw[1]),
          state: dco_decode_box_autoadd_file_state(raw[2]),
        );
      case 2:
        return SessionEvent_Progress(
          fileId: dco_decode_String(raw[1]),
          bytes: dco_decode_i_64(raw[2]),
        );
      case 3:
        return SessionEvent_Failed(
  ...
  FileState sse_decode_box_autoadd_file_state(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_file_state(deserializer));
  }
  ...
  NodeDevice? sse_decode_opt_box_autoadd_node_device(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_node_device(deserializer));
    } else {
      return null;
    }
  }
  ...
  SessionEvent sse_decode_session_event(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        var var_field0 = sse_decode_mission_state(deserializer);
        return SessionEvent_StateChanged(var_field0);
      case 1:
        var var_fileId = sse_decode_String(deserializer);
        var var_state = sse_decode_box_autoadd_file_state(deserializer);
        return SessionEvent_FileStateChanged(
            fileId: var_fileId, state: var_state);
      case 2:
        var var_fileId = sse_decode_String(deserializer);
        var var_bytes = sse_decode_i_64(deserializer);
        return SessionEvent_Progress(fileId: var_fileId, bytes: var_bytes);
      case 3:
        var var_reason = sse_decode_String(deserializer);
        return SessionEvent_Failed(reason: var_reason);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  SessionSummary sse_decode_session_summary(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_id = sse_decode_String(deserializer);
    var var_direction = sse_decode_session_direction(deserializer);
  ...
  void sse_encode_box_autoadd_file_state(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_file_state(self, serializer);
  }
  ...
  void sse_encode_opt_box_autoadd_node_device(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_node_device(self, serializer);
    }
  }
  ...
  void sse_encode_session_event(SessionEvent self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case SessionEvent_StateChanged(field0: final field0):
        sse_encode_i_32(0, serializer);
        sse_encode_mission_state(field0, serializer);
      case SessionEvent_FileStateChanged(
        ...
        sse_encode_box_autoadd_file_state(state, serializer);
      case SessionEvent_Progress(fileId: final fileId, bytes: final bytes):
        sse_encode_i_32(2, serializer);
        sse_encode_String(fileId, serializer);
        sse_encode_i_64(bytes, serializer);
      case SessionEvent_Failed(reason: final reason):
        sse_encode_i_32(3, serializer);
  ...
  void sse_encode_session_summary(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.id, serializer);
    sse_encode_session_direction(self.direction, serializer);
