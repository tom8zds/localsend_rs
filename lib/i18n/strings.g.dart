...
///
/// Built on 2024-07-04 at 14:24 UTC
...
class _StringsZh implements Translations {
  ...
  // Translations
  @override
  String get appTitle => '锈船';
  @override
  late final _StringsHomeZh home = _StringsHomeZh._(_root);
  @override
  late final _StringsSettingZh setting = _StringsSettingZh._(_root);
}
...
class _StringsSettingZh implements _StringsSettingEn {
  ...
  @override
  late final _StringsSettingBrightnessZh brightness =
      _StringsSettingBrightnessZh._(_root);
  @override
  late final _StringsSettingLanguageZh language =
      _StringsSettingLanguageZh._(_root);
  @override
  late final _StringsSettingCoreZh core = _StringsSettingCoreZh._(_root);
}
...
class _StringsSettingBrightnessZh implements _StringsSettingBrightnessEn {
  ...
  @override
  String subTitle({required Object mode}) => '当前模式: ${mode}';
  @override
  late final _StringsSettingBrightnessThemeModeZh themeMode =
      _StringsSettingBrightnessThemeModeZh._(_root);
}
...
class _StringsSettingLanguageZh implements _StringsSettingLanguageEn {
  ...
  @override
  String subTitle({required Object language}) => '当前语言: ${language}';
}
...
class _StringsSettingCoreZh implements _StringsSettingCoreEn {
  ...
  // Translations
  @override
  String get title => '核心设置';
  @override
  late final _StringsSettingCoreServerZh server =
      _StringsSettingCoreServerZh._(_root);
}

// Path: setting.brightness.themeMode
class _StringsSettingBrightnessThemeModeZh
    implements _StringsSettingBrightnessThemeModeEn {
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'setting.brightness.title':
        return '明暗';
      case 'setting.brightness.subTitle':
        return ({required Object mode}) => '当前模式: ${mode}';
      case 'setting.brightness.themeMode.system':
        return '跟随系统';
      case 'setting.brightness.themeMode.light':
        return '浅色模式';
      ...
      case 'setting.language.title':
        return '语言';
      case 'setting.language.subTitle':
        return ({required Object language}) => '当前语言: ${language}';
      case 'setting.core.title':
        return '核心设置';
      case 'setting.core.server.title':
        return '服务器';
